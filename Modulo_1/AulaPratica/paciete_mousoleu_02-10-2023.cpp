...
class mausoleu {
    ...
    void mausoleu::listaPacientesPorMausoleu() {
    cout << "-----------Pacientes do Mausoleu " << getId() << "----------" << endl;
...
int main() {
    ...
    do {
        ...
        cout << "3. Listar Paciente por Mausoleus" << endl;
        cout << "0. Sair" << endl;
        cout << "Digite opcao: ";
        cin >> op;
        cin.ignore();
        ...
        if (op == 4) { // Adicione a opção 4 para listar pacientes de um mausoléu
            limpaTela();
            cout << "Digite o ID do mausoleu para listar os pacientes: ";
            int idMausoleu;
            cin >> idMausoleu;

            bool encontrado = false;
            for (const mausoleu& m : mausoleus) {
                if (m.getId() == idMausoleu) {
                    m.listaPacientesPorMausoleu();
                    encontrado = true;
                    break;
                }
            }
            ...
            if (!encontrado) {
                cout << "Mausoleu com ID " << idMausoleu << " não encontrado." << endl;
            }
        };
